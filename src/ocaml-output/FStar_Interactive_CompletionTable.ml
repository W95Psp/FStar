...
type 'a heap =
  | EmptyHeap 
  | Heap of ('a * 'a heap Prims.list) [@@deriving show]
...
type 'a btree =
  | StrEmpty 
  | StrBranch of (Prims.string * 'a * 'a btree * 'a btree) [@@deriving show]
...
type 'a name_collection =
  | Names of 'a btree 
  | ImportedNames of (Prims.string * 'a name_collection Prims.list) [@@deriving
                                                                    show]
