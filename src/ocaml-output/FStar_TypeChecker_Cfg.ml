...
type fsteps =
  ...
  nbe_step: Prims.bool ;
  for_extraction: Prims.bool }[@@deriving show]
...
type debug_switches =
  ...
  debug_nbe: Prims.bool }[@@deriving show]
...
let (__proj__Mkprimitive_step__item__interpretation_nbe :
  ...
  fun projectee ->
    ...
    | { name; arity; univ_arity; auto_reflect; strong_reduction_ok;
        requires_binder_substitution; interpretation; interpretation_nbe;_}
        -> interpretation_nbe
type prim_step_set = primitive_step FStar_Compiler_Util.psmap[@@deriving
                                                               show]
...
type cfg =
  ...
  reifying: Prims.bool }[@@deriving show]
...
type register_prim_step_t = primitive_step -> unit[@@deriving show]
type retrieve_prim_step_t = unit -> prim_step_set[@@deriving show]
