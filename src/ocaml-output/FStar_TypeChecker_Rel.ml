...
type lstring = Prims.string FStar_Thunk.t[@@deriving show]
...
type uvi =
  ...
  FStar_Syntax_Syntax.universe) [@@deriving show]
...
type worklist =
  ...
  repr_subcomp_allowed: Prims.bool }[@@deriving show]
...
type solution =
  ...
  | Failed of (FStar_TypeChecker_Common.prob * lstring) [@@deriving show]
...
let (wl_to_string : worklist -> Prims.string) =
  fun wl ->
    let uu___ =
      let uu___1 =
        let uu___2 =
          FStar_Compiler_Effect.op_Bar_Greater wl.wl_deferred
            (FStar_Compiler_List.map
               (fun uu___3 ->
                  match uu___3 with | (uu___4, uu___5, uu___6, x) -> x)) in
        FStar_Compiler_List.op_At wl.attempting uu___2 in
      FStar_Compiler_List.map (wl_prob_to_string wl) uu___1 in
    FStar_Compiler_Effect.op_Bar_Greater uu___ (FStar_String.concat "\n\t")
type flex_t =
  | Flex of (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.ctx_uvar *
  FStar_Syntax_Syntax.args) [@@deriving show]
...
type univ_eq_sol =
  ...
  | USolved of worklist 
  | UFailed of lstring [@@deriving show]
                                        ...
                                        let uu___6 =
                                          let uu___7 =
                                            FStar_Syntax_Syntax.mk_binder_with_attrs
                                              y imp attrs in
                                          [uu___7] in
                                        FStar_Compiler_List.op_At bs uu___6 in
                                      let uu___6 =
                                        let uu___7 =
                                          let uu___8 =
                                            let uu___9 =
                ...
                let first_order orig1 env1 wl1 lhs1 rhs1 =
                  (let uu___4 =
                     FStar_Compiler_Effect.op_Less_Bar
                       ...
                       (FStar_Options.Other "Rel") in
                   if uu___4
                   then FStar_Compiler_Util.print_string "first_order\n"
                   else ());
                  (let is_app rhs2 =
                 ...
                 | ((uu___3,
                     {
                       ...
                       FStar_Syntax_Syntax.vars = uu___7;_}),
                    (s, t)) ->
                     let uu___8 =
                         ...
                         ((let uu___12 =
                          ...
                          (let pat_discriminates uu___12 =
                             ...
                             | ({
                                ...
                                FStar_Pervasives_Native.None, uu___15) ->
                                 true
                             | ({
                                  FStar_Syntax_Syntax.v =
                           ...
                           | FStar_Pervasives_Native.None ->
                               ((let uu___13 =
                                ...
                                (let try_branches =
                                 ...
                                 FStar_Compiler_Effect.op_Less_Bar
                                   (fun uu___14 ->
                                      FStar_Pervasives.Inr uu___14) uu___13))
                     ...
                     let try_reveal_hide env2 t11 t21 =
                       ...
                       | (FStar_Pervasives_Native.Some (FStar_Pervasives.Inl
                          (u, ty, lhs)), FStar_Pervasives_Native.None) ->
                           let rhs =
                             mk_fv_app FStar_Parser_Const.hide u
                               [(ty,
                                  (FStar_Pervasives_Native.Some
                       ...
                       | (FStar_Pervasives_Native.Some (FStar_Pervasives.Inr
                          (u, ty, lhs)), FStar_Pervasives_Native.None) ->
                           let rhs =
                             mk_fv_app FStar_Parser_Const.reveal u
                               [(ty,
                                  (FStar_Pervasives_Native.Some
                                     (FStar_Syntax_Syntax.Implicit false)));
                               (t21, FStar_Pervasives_Native.None)]
                               ...
                               FStar_Compiler_Effect.op_Bar_Greater uu___7
                                 (fun ts ->
                                    let uu___8 =
                                      ...
                                      FStar_Compiler_Effect.op_Bar_Greater
                                        uu___9 FStar_Pervasives_Native.snd in
                                    FStar_Compiler_Effect.op_Bar_Greater
                                      uu___8
                                      (fun uu___9 ->
                    ...
                    (let uu___5 =
                       ...
                       then ([], wl1)
                         ...
                         (let rec is_uvar t =
                            ...
                            match uu___7 with
                            | FStar_Syntax_Syntax.Tm_uvar (uv, uu___8) ->
                                let uu___9 =
                                  FStar_TypeChecker_DeferredImplicits.should_defer_uvar_to_user_tac
                                    env uv in
                                Prims.op_Negation uu___9
                            | FStar_Syntax_Syntax.Tm_uinst (t1, uu___8) ->
                                is_uvar t1
                            | FStar_Syntax_Syntax.Tm_app (t1, uu___8) ->
                                is_uvar t1
                            | uu___8 -> false in
                          FStar_Compiler_List.fold_right2
                            (fun uu___7 ->
                          ...
                          | (ret_sub_prob, wl3) ->
                              ...
                              let uu___7 =
                                ...
                                | FStar_Syntax_Syntax.Tm_arrow (bs, c) when
                                    ...
                                    (match uu___9 with
                                     | (bs', c3) ->
                                         let a = FStar_Compiler_List.hd bs' in
                                         let bs1 =
            ...
            (fun uu___1 ->
               (let uu___3 =
                ...
                then
                  ...
                  let uu___5 = FStar_Syntax_Print.term_to_string t2 in
                  FStar_Compiler_Util.print2 "try_teq of %s and %s {\n"
                    uu___4 uu___5
                else ());
               (let uu___3 =
            ...
            FStar_Profiling.profile
              (fun uu___1 ->
                 ...
                 (let uu___3 =
                  ...
                  if uu___3
                  then
                    let uu___4 = FStar_Compiler_Util.string_of_bool defer_ok in
...
type implicit_checking_status =
  | Implicit_unresolved 
  | Implicit_checking_defers_univ_constraint [@@deriving show]
                          ...
                          (let uu___3 = unresolved ctx_u in
                           ...
                           then
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 (env_dyn, tau)) ->
                                 let env1 = FStar_Compiler_Dyn.undyn env_dyn in
                                 ((let uu___5 =
                                     FStar_TypeChecker_Env.debug env1
                                       (FStar_Options.Other "Tac") in
                                   if uu___5
                                   ...
                                   let ctx_u1 =
                                     {
                                       ...
                                       FStar_Syntax_Syntax.ctx_uvar_reason =
                                         (ctx_u.FStar_Syntax_Syntax.ctx_uvar_reason);
                                       FStar_Syntax_Syntax.ctx_uvar_should_check
                                         =
                                         (ctx_u.FStar_Syntax_Syntax.ctx_uvar_should_check);
                                       FStar_Syntax_Syntax.ctx_uvar_range =
                                         (ctx_u.FStar_Syntax_Syntax.ctx_uvar_range);
                               ...
                               (let env1 =
                                ...
                                let tm_ok_for_tac tm2 =
                                  let uu___6 =
                                    ...
                                    FStar_Compiler_Effect.op_Bar_Greater
                                      uu___7 FStar_Compiler_Util.set_elements in
                                  FStar_Compiler_Effect.op_Bar_Greater uu___6
                                    (FStar_Compiler_List.for_all
                                       (fun uv ->
                                          uv.FStar_Syntax_Syntax.ctx_uvar_should_check
