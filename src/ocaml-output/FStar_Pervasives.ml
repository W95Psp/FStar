...
type pattern = unit[@@deriving show]


type 'p spinoff = 'p[@@deriving show]

let id : 'a . 'a -> 'a = fun x -> x
type ('a, 'uuuuu) trivial_pure_post = unit[@@deriving show]
type ('uuuuu, 'uuuuu1) ambient = unit[@@deriving show]

let normalize_term : 'uuuuu . 'uuuuu -> 'uuuuu = fun x -> x
type 'a normalize = 'a[@@deriving show]
type norm_step =
  | Simpl 
  | Weak 
  | HNF 
...
type ('a, 'x, 'uuuuu) pure_return = unit[@@deriving show]
type ('a, 'b, 'wp1, 'wp2, 'uuuuu) pure_bind_wp = 'wp1[@@deriving show]
type ('a, 'p, 'wputhen, 'wpuelse, 'uuuuu) pure_if_then_else = unit[@@deriving
                                                                    show]
type ('a, 'wp, 'uuuuu) pure_ite_wp = unit[@@deriving show]
type ('a, 'b, 'wp, 'uuuuu) pure_close_wp = unit[@@deriving show]
type ('a, 'uuuuu) pure_null_wp = unit[@@deriving show]
type ('p, 'uuuuu) pure_assert_wp = unit[@@deriving show]
type ('p, 'uuuuu) pure_assume_wp = unit[@@deriving show]
type ('a, 'pre, 'post, 'uuuuu) div_hoare_to_wp = unit[@@deriving show]
type 'heap st_pre_h = unit[@@deriving show]
type ('heap, 'a, 'pre) st_post_h' = unit[@@deriving show]
type ('heap, 'a) st_post_h = unit[@@deriving show]
type ('heap, 'a) st_wp_h = unit[@@deriving show]
type ('heap, 'a, 'x, 'p, 'uuuuu) st_return = 'p[@@deriving show]
type ('heap, 'a, 'b, 'wp1, 'wp2, 'p, 'h0) st_bind_wp = 'wp1[@@deriving show]
type ('heap, 'a, 'p, 'wputhen, 'wpuelse, 'post, 'h0) st_if_then_else = unit
[@@deriving show]
type ('heap, 'a, 'wp, 'post, 'h0) st_ite_wp = unit[@@deriving show]
type ('heap, 'a, 'wp1, 'wp2) st_stronger = unit[@@deriving show]
type ('heap, 'a, 'b, 'wp, 'p, 'h) st_close_wp = unit[@@deriving show]
type ('heap, 'a, 'wp) st_trivial = unit[@@deriving show]
type 'a result =
  | V of 'a 
  | E of Prims.exn 
...
type ('a, 'pre) ex_post' = unit[@@deriving show]
type 'a ex_post = unit[@@deriving show]
type 'a ex_wp = unit[@@deriving show]
type ('a, 'x, 'p) ex_return = 'p[@@deriving show]
type ('a, 'b, 'wp1, 'wp2, 'p) ex_bind_wp = unit[@@deriving show]
type ('a, 'p, 'wputhen, 'wpuelse, 'post) ex_if_then_else = unit[@@deriving
                                                                 show]
type ('a, 'wp, 'post) ex_ite_wp = unit[@@deriving show]
type ('a, 'wp1, 'wp2) ex_stronger = unit[@@deriving show]
type ('a, 'b, 'wp, 'p) ex_close_wp = unit[@@deriving show]
type ('a, 'wp) ex_trivial = 'wp[@@deriving show]
type ('a, 'wp, 'p) lift_div_exn = 'wp[@@deriving show]
type 'h all_pre_h = unit[@@deriving show]
type ('h, 'a, 'pre) all_post_h' = unit[@@deriving show]
type ('h, 'a) all_post_h = unit[@@deriving show]
type ('h, 'a) all_wp_h = unit[@@deriving show]
type ('heap, 'a, 'x, 'p, 'uuuuu) all_return = 'p[@@deriving show]
type ('heap, 'a, 'b, 'wp1, 'wp2, 'p, 'h0) all_bind_wp = 'wp1[@@deriving show]
type ('heap, 'a, 'p, 'wputhen, 'wpuelse, 'post, 'h0) all_if_then_else = unit
[@@deriving show]
type ('heap, 'a, 'wp, 'post, 'h0) all_ite_wp = unit[@@deriving show]
type ('heap, 'a, 'wp1, 'wp2) all_stronger = unit[@@deriving show]
type ('heap, 'a, 'b, 'wp, 'p, 'h) all_close_wp = unit[@@deriving show]
type ('heap, 'a, 'wp) all_trivial = unit[@@deriving show]
type 'uuuuu inversion = unit[@@deriving show]
...
type ('a, 'b, 'c) dtuple3 =
  | Mkdtuple3 of 'a * 'b * 'c [@@deriving show]
...
type ('a, 'b, 'c, 'd) dtuple4 =
  | Mkdtuple4 of 'a * 'b * 'c * 'd [@@deriving show]
...
type 'a eqtype_as_type = 'a[@@deriving show]