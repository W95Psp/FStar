                ...
                let e1 =
                  {
                    ...
                    FStar_TypeChecker_Env.use_eq =
                      (e.FStar_TypeChecker_Env.use_eq);
                ...
                let e2 =
                  {
                    ...
                    FStar_TypeChecker_Env.use_eq =
                      (e1.FStar_TypeChecker_Env.use_eq);
                    FStar_TypeChecker_Env.use_eq_strict =
         ...
         | (lbs, body) ->
             let uu___1 =
               FStar_Syntax_Syntax.mk
                 ...
                 FStar_Compiler_Range.dummyRange in
             FStar_Compiler_Effect.op_Less_Bar FStar_Tactics_Monad.ret uu___1)
        ...
        let env4 =
          {
            ...
            FStar_TypeChecker_Env.use_eq =
              (env3.FStar_TypeChecker_Env.use_eq);
            FStar_TypeChecker_Env.use_eq_strict =
        ...
        let env5 =
          {
            ...
            FStar_TypeChecker_Env.use_eq =
              (env4.FStar_TypeChecker_Env.use_eq);
            FStar_TypeChecker_Env.use_eq_strict =
...
let (string_to_term :
  ...
  fun env1 ->
    fun str ->
      ...
      let string_to_AST_term term =
        let uu___ =
          let uu___1 =
            FStar_Compiler_Effect.op_Less_Bar
              (fun uu___2 -> FStar_Parser_ParseIt.Fragment uu___2)
              (frag_of_text term) in
          FStar_Parser_ParseIt.parse uu___1 in
        match uu___ with
        | FStar_Parser_ParseIt.Term x -> x
        | uu___1 ->
            failwith
              (Prims.op_Hat "Could not parse term '" (Prims.op_Hat term "'")) in
      let denv =
        let uu___ = FStar_TypeChecker_Env.current_module env1 in
        FStar_Syntax_DsEnv.set_current_module
          env1.FStar_TypeChecker_Env.dsenv uu___ in
      let uu___ =
        let uu___1 = string_to_AST_term str in
        FStar_ToSyntax_ToSyntax.desugar_term denv uu___1 in
      FStar_Compiler_Effect.op_Less_Bar FStar_Tactics_Monad.ret uu___